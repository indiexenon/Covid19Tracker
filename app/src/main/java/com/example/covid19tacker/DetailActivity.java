...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Details of "+AffectedCountries.countryModalList.get(positionCountry).getCountry());
        ...
        tvTodayCases.setText(AffectedCountries.countryModalList.get(positionCountry).gettodayscase());
        tvTotalDeaths.setText(AffectedCountries.countryModalList.get(positionCountry).getDeath());
        tvTodayDeaths.setText(AffectedCountries.countryModalList.get(positionCountry).gettodaysdeath());
